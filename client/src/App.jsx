                    ...
                    <p style={{ fontSize: '13px', lineHeight: '1.4' }}>
                      {insights.highestIncreaseCat !== "None" && (
                        <span style={{ display: 'block', color: '#dc2626' }}>
                          <span style={{ color: '#dc2626' }}>↑</span> Largest Increase: <strong>{insights.highestIncreaseCat}</strong> (+₹{insights.maxIncreaseDiff.toLocaleString()})
                        </span>
                      )}
                  ...
                  <div className="insight-item">
                    ...
                    <p style={{ fontSize: '13px', lineHeight: '1.4' }}>
                      {insights.highestIncreaseYearCat !== "None" && (
                        <span style={{ display: 'block', color: '#dc2626' }}>
                          <span style={{ color: '#dc2626' }}>↑</span> Largest Increase: <strong>{insights.highestIncreaseYearCat}</strong> (+₹{insights.maxIncreaseYearDiff.toLocaleString()})
                        </span>
                      )}
